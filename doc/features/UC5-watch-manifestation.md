...
- cobertura e2e em `test/e2e/identified-manifestation.e2e.spec.ts` exercita listagem, detalhes (`history === ['registered']` para manifestação recém-criada, `messages === []`), `401` sem auth e `403` entre manifestantes distintos;
